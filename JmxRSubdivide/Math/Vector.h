...
#pragma endregion
	...
	{
		Point3() { x = y = 0; }
		Point3(f32 val) :x(val), y(val),z(val){}
	...
	FORCEINLINE Normal operator*(f32 v, const Normal& n)
	{
		return Normal(v*n.x, v*n.y, v*n.z);
	}
	FORCEINLINE Normal operator*(const Normal& n,f32 v)
	{
		return v*n;
	}
	...
	FORCEINLINE Normal normalize(const Normal& n)
	{
